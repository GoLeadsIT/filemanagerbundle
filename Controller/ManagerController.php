...
namespace Goleadsit\FileManagerBundle\Controller;

use Goleadsit\FileManagerBundle\Event\FileManagerEvents;
use Goleadsit\FileManagerBundle\Helpers\File;
use Goleadsit\FileManagerBundle\Helpers\FileManager;
use Goleadsit\FileManagerBundle\Helpers\UploadHandler;
use Goleadsit\FileManagerBundle\Twig\OrderExtension;
...
class ManagerController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if ($isJson) {
            $fileList = $this->renderView('@GoleadsitFileManager/views/_manager_view.html.twig', $parameters);
        ...
        return $this->render('@GoleadsitFileManager/manager.html.twig', $parameters);
    }
    ...
    private function getBasePath($queryParameters)
    {
        ...
        $managerConf = $this->getParameter('goleadsit_file_manager')['conf'];
    ...
    private function newFileManager($queryParameters)
    {
        ...
        $webDir = $this->getParameter('goleadsit_file_manager')['web_dir'];
